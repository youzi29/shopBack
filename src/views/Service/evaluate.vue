		...
		<div class="xw-evaluate-content">
			<ul class="xw-score-list">
				<li v-for="items in ScoreDB.scoreDatas">
					...
					<nav>
						<a href="javascript:;" v-for="(item ,index) in items.scoreArr" @click="scoreFuc(index+1, items.scoreFlag,items.scoreArr)"
						 :class="[item==index ? 'xw-score-active' : 'xw-score-notActiv']"></a>
					</nav>
