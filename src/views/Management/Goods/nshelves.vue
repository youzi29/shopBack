<template>
	<div class="add">
		...
		<div class="content" style="margin-top: 20px;">
			...
			<div class="list" >
				<div class="list-one" v-for="(item , index) in goodslist">
					<div class="list-one-top" @click="edit(item.id)">
						<img :src="item.img"/>
					</div>
					<div class="list-one-bottom">
						...
						<div class="bottom-two">
							<!-- <button @click="edit(item.id)"><i>编辑</i></button>
							<button class="add1" @click="delete1(item.id)"><i>删除</i></button> -->
	    ...
	    <div class="pop" v-if="show" >
	         <GoodsInfo :id="goodsid" @childevent="colse" /><!--商品详情 -->
		</div>
...
<script>
	...
	export default{
		name:'goodslist',
		components:{GoodsInfo , GoodsModify},
		mounted(){
			let data={
				status:'searchDown'
			}
