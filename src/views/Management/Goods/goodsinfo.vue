			...
			<div class="right-form">
				...
				<div class="listtwo">
					...
					<div class="listtwo-pic">
						<div class="img-files">
							<div >
								<div class="img-box" v-for="(item , index) in goodsad" >
									<img :src="item.url" alt=""> </span>
								</div>
							</div>
						</div>
	...
	export default {
		...
		mounted(){
			 ...
			 add1(data).then(res => {
				...
				//console.log(this.goodsinfo.ad)//广告图片
				
			 	//console.log(this.goodssize)//规格
				//console.log(this.goodsinfo.detail)//详细图片
			 }).catch(err => {
			 	console.log(err);
			 });
		},
